	...
	<tr>
		...
		<td>
		   <select name="BOARD_MAINCATEGORY" id="BOARD_MAINCATEGORY" style="width:200px">
		        <option value="${boarddata.board_mainCategory }">${boarddata.board_mainCategory }</option>
		   </select>
		   <select name="BOARD_SUBCATEGORY" id="BOARD_SUBCATEGORY" style="width:200px">
		        <option value="${boarddata.board_subCategory }">${boarddata.board_subCategory }</option>
		   </select>
		</td>
	</tr>
	<tr>
