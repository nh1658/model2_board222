	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		String realFolder="";
   		...
   		try{
   			...
   			boarddata.setBoard_mainCategory(multi.getParameter("BOARD_MAINCATEGORY").trim());
   			boarddata.setBoard_subCategory(multi.getParameter("BOARD_SUBCATEGORY").trim());
			...
			System.out.println("mainCategory="+boarddata.getBoard_mainCategory());
			System.out.println("subCategory="+boarddata.getBoard_subCategory());
